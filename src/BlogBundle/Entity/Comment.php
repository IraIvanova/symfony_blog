...
class Comment
{
     ...
     * @var string
     *
     * @ORM\Column(name="blog_user", type="string", length=255)
     */
    private $blogUser;
     ...
     * @var Blog
     *
     * @ORM\ManyToOne(targetEntity="BlogBundle\Entity\Blog", inversedBy="comments")
     ...
     * @return Comment
     */
    public function setBlogUser($blogUser)
    {
